...
public class CompanyController {
	...
	public ResponseEntity<CompanyDTO> getCompanyById(@PathVariable(value = "id") Long id){
		...
		CompanyDTO CompanyByIdDTO = companyMapper.getCompanyDTO(companyById);
		return ResponseEntity.status(HttpStatus.OK).body(CompanyByIdDTO);
	...
	@GetMapping(value="/getcompanybycompanycode/{code}")
	public ResponseEntity<CompanyDTO> getCompanyByCompanyCode(@PathVariable(value = "code") String code){
		Company companyByCode = companyService.getCompanyByCompanyCode(code);
		CompanyDTO CompanyByCodeDTO = companyMapper.getCompanyDTO(companyByCode);
		return ResponseEntity.status(HttpStatus.OK).body(CompanyByCodeDTO);
